...
Vavourakis CD*, Weber DD*, Aminzadeh-Gohari S*, Tevini J, Barret JE, Herzog C, Catalano L, Stefan VE, Redl E, Alkasalias T, Felder TK, Lang R, Kofler B, Widschwendter M. Ketogenic diet and mifepristone attenuate progestin-driven epigenetic remodeling in a murine breast cancer model. <br>
If you are happily reusing some of the code or analysis frameworks, please cite us! <br>
<br><br>
EpiMod functions from West et al (2013) Scientific reports https://doi.org/10.1038/srep01630 were revised to work with igraph package version 2.2.2. <br> 
